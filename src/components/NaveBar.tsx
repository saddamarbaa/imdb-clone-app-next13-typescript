...
export default function NaveBar() {
	return (
		<div className="mt-6 mb-5 flex flex-col flex-wrap items-center justify-center space-y-4  bg-amber-100 p-4 dark:bg-gray-600 sm:flex-row lg:space-y-0 lg:text-lg">
			...
			<NaveBarItem title="Comedy" param="fetchCrimeMovies" />
