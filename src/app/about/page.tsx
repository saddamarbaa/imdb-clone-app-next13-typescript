...
export default function page() {
	return (
		<div className="mx-auto max-w-6xl space-y-5 p-4">
			...
			<p>
				Our website also provides valuable information about the movie industry
				and its history. You can explore our database to learn more about iconic
				filmmakers and actors, as well as discover hidden gems from different
				eras and countries. We also feature articles and blog posts that delve
				into the behind-the-scenes aspects of movie production, providing
				insights into the creative process and the challenges involved in
				bringing a film to life. Whether you are a casual moviegoer or a film
				buff, our website has something for everyone.
			</p>
			<p>
				At our IMDb clone website, we prioritize user experience and
				accessibility. We strive to make our website easy to navigate and use,
				whether you are searching for a specific movie or browsing for
				recommendations. Our user-friendly interface allows you to filter and
				sort movies based on various criteria, and our search bar provides
				instant results based on your queries. We also ensure that our website
				is compatible with different devices and browsers, so you can access our
				content seamlessly from anywhere. We are committed to providing a
				hassle-free and enjoyable experience for our users, and we welcome your
				feedback and suggestions to help us achieve that goal.
			</p>
		</div>
	)
}
